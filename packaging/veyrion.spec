...
"""PyInstaller spec for Veyrion Workspace (Windows one-folder build, no console).

Build:  pyinstaller packaging/veyrion.spec --noconfirm
Output: dist/VeyrionWorkspace/VeyrionWorkspace.exe
"""
import sys
...
exe = EXE(
    ...
    icon=str(ROOT / "resources" / "icons" / "veyrion.ico"),
)
