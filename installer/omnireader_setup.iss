; OmniReader Pro — Windows installer (Inno Setup 6)
; Build:  ISCC.exe installer\omnireader_setup.iss
; Requires the PyInstaller output at dist\OmniReaderPro\.
; Inno Setup: https://jrsoftware.org/isinfo.php

#define MyAppName "OmniReader Pro"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "OmniReader"
#define MyAppExeName "OmniReaderPro.exe"
#define MyAppAssocName "OmniReader Document"
#define MyAppAssocExt ".pdf"
#define MyAppAssocKey StringChange(MyAppAssocName, " ", "") + MyAppAssocExt

[Setup]
AppId={{8C4E1B2A-5F2C-4E9B-9C1E-OMNIREADER01}
AppName={#MyAppName}
...
OutputBaseFilename=OmniReaderPro-Setup-{#MyAppVersion}
SetupIconFile=..\resources\icons\omnireader.ico
...
[Files]
Source: "..\dist\OmniReaderPro\*"; DestDir: "{app}"; Flags: recursesubdirs ignoreversion
...
; by default keep user documents. App data lives in %APPDATA%\OmniReader Pro.
Type: dirifempty; Name: "{userappdata}\OmniReader Pro"
...
begin
  if CurUninstallStep = usUninstall then begin
    if MsgBox('Keep your documents, library, and settings? (Recommended)', mbConfirmation, MB_YESNO or MB_DEFBUTTON1) = IDNO then begin
      DelTree(ExpandConstant('{userappdata}\OmniReader Pro'), True, True, True);
    end;
  end;
end;