...
from omnireader_pro.utils.pathutils import safe_filename
from omnireader_pro.utils.safeio import make_temp_dir

logger = logging.getLogger("omnireader.comic")
