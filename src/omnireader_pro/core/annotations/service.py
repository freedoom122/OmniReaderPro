...
from omnireader_pro.core.documents.base import Capability, DocumentEngine
from omnireader_pro.storage.repositories import AnnotationRecord, AnnotationRepository

logger = logging.getLogger("omnireader.annotations")
