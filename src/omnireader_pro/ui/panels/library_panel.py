...
from omnireader_pro.core.library.scanner import import_document
...
class LibraryPanel(QWidget):
    ...
    def import_folder(self, folder: Path) -> None:
        from omnireader_pro.core.library.scanner import scan_folder
    ...
    def _context_menu(self, path, global_pos) -> None:
        ...
        if chosen is open_act:
            ...
            confirm = QMessageBox.question(
                ...
                f"This cannot be undone from OmniReader.")
