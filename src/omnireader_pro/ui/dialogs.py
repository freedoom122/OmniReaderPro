...
from omnireader_pro.ui.icons import icon, pixmap
from omnireader_pro.ui.theme import Palette
from omnireader_pro.ui.widgets import HelpLabel, show_toast
...
class PrintDialog(QDialog):
    ...
    def _do_print(self) -> None:
        ...
        from omnireader_pro.utils.safeio import make_temp_file
        pages = self._pages()
    ...
    def _send(self, out: Path) -> None:
        from omnireader_pro.core.printing.printing import send_to_printer
...
class ExportDialog(QDialog):
    ...
    def _do_export(self) -> None:
        ...
        if choice.startswith("PNG"):
            ...
            if not out_dir:
                return
            from omnireader_pro.core.conversion.convert import pdf_to_images
            ...
            if not target:
                return
            from omnireader_pro.core.conversion.convert import pdf_to_text
...
class TranslateDialog(QDialog):
    ...
    def _translate(self) -> None:
        ...
        from omnireader_pro.core.translation import (
...
class CompareDialog(QDialog):
    ...
    def _show(self, result) -> None:
        ...
        from omnireader_pro.core.comparison.comparator import compare_texts
        diff_text = "\n".join(compare_texts(
...
class VerifyRedactionDialog(QDialog):
    ...
    def __init__(self, parent, pdf_engine) -> None:
        ...
        lay.addWidget(QLabel(
            "Enter phrases that were redacted (one per line). OmniReader "
        ...
        lay.addWidget(self._result, 1)
        lay.addWidget(HelpLabel(
            "Note: PDF is a complex format; OmniReader verifies extracted "
    ...
    def _verify(self) -> None:
        ...
        if not phrases:
            return
        from omnireader_pro.core.documents.pdf_engine import (
...
class SignDialog(QDialog):
    ...
    def __init__(self, parent, view) -> None:
        ...
        self.view = view
        lay = QVBoxLayout(self)
        from omnireader_pro.core.security.signing import HAS_PYHANKO
        if not HAS_PYHANKO:
            lay.addWidget(HelpLabel(
                "Cryptographic PDF signing requires the optional 'pyhanko' "
                "package (pip install pyhanko). OmniReader will not fake a "
    ...
    def _sign(self) -> None:
        from omnireader_pro.core.security.signing import (
...
class VaultDialog(QDialog):
    ...
    def __init__(self, parent, settings) -> None:
        ...
        self._settings = settings
        from omnireader_pro.core.security.vault import Vault, vault_directory
    ...
    def _unlock(self) -> None:
        from omnireader_pro.ui.dialogs import get_password
        from omnireader_pro.core.security.vault import VaultError
...
class PrivacyDialog(QDialog):
    ...
    def __init__(self, parent, db, settings) -> None:
        ...
        lay.addWidget(HelpLabel(
            "OmniReader makes no network requests unless you explicitly "
