...
class SettingsDialog(QDialog):
    def __init__(self, parent, settings=None) -> None:
        ...
        from veyrion_workspace.services.settings import Settings as _Settings
    ...
    def _page_ocr(self, layout) -> None:
        ...
        from veyrion_workspace.core.ocr.ocr import tesseract_available, tesseract_version
    ...
    def _page_privacy(self, layout) -> None:
        ...
        layout.addWidget(HelpLabel(
            "Veyrion never sends telemetry. Network access only happens "
    ...
    def _page_data(self, layout) -> None:
        ...
        logs_btn.clicked.connect(lambda: __import__(
            "veyrion_workspace.app.logging_setup",
